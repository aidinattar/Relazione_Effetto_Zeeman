...
\end{center}
	...
	\begin{center}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.32, angle=0]{spectrum.pdf}
	...
	\begin{center}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.32, angle=0]{zoomspectrum.pdf}
	...
	da $\lambda \approx$ 3, per cui il fit si può considerare buono, e il valore
...
\begin{tabular} {| c | c | c | c |c |}
\hline
set	& Range (pixcel)& $\Delta\lambda_{Zee} $ (nm) & g \\
\hline
